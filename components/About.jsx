...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          "Hello! I'm Priyansh Agrawal, a pre-final year student currently
          pursuing my B.Tech in Electronics and Communication Engineering at
          PDPM Indian Institute of Information Technology Design and
          Manufacturing, Jabalpur, Madhya Pradesh. I'm passionate Full Stack Web
          Developer and Competitive Programmer with a knack for problem-solving
